...
public class Produtos extends JDialog {
	...
	public Produtos() {
		...
		lblEstoque.setBounds(25, 420, 86, 14);
		...
		txtEstoqueMin.setBounds(137, 459, 231, 20);
		...
		lblUnid.setBounds(695, 461, 61, 14);
		...
		cboUNID.setBounds(738, 457, 46, 22);
		...
		lblLocalDeArmazem.setBounds(383, 449, 52, 14);
		...
		txtLocalArmazenamento.setBounds(464, 460, 221, 20);
		...
		lblArmazenamento.setBounds(383, 463, 121, 21);
		...
		btnAdicionar.setBounds(45, 496, 60, 60);
		...
		btnEditar.setBounds(184, 496, 60, 60);
		...
		btnExcluir.setBounds(342, 496, 60, 60);
		...
		btnLimpar.setBounds(486, 496, 60, 60);
		...
		lblFoto.setBounds(517, 98, 256, 256);
		...
		txtLucro.setBounds(667, 412, 106, 20);
		getContentPane().add(txtLucro);

		dateVal = new JDateChooser();
		dateVal.setBounds(464, 414, 139, 20);
		getContentPane().add(dateVal);

		dateEnt = new JDateChooser();
		dateEnt.setBounds(464, 375, 139, 20);
		...
		chckFoto.setBounds(352, 177, 121, 32);
